...
\begin{figure}[!ht]
    \centering
    \subfigure[1h]{\includegraphics[width=0.95\textwidth]{images/aroon-macd/crypto-result.png}
        \label{fig:aroon-macd-crypto}}
    \subfigure[1d]{\includegraphics[width=0.95\textwidth]{images/aroon-macd/crypto-result-1d.png}}
...
\begin{figure}[!ht]
    ...
    \subfigure[1d]{\includegraphics[width=0.95\textwidth]{images/aroon-macd/stock-result-1d.png}}
...
\begin{figure}[!ht]
    \centering
    \subfigure[1h]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/crypto-result.png}
        \label{fig:rsi-bb-crypto}
    }
    \subfigure[1d]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/crypto-result-1d.png}}
...
\begin{figure}[!ht]
    \centering
    \subfigure[1h]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/stock-result.png}
        \label{fig:rsi-bb-stock}
    }
    \subfigure[1d]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/stock-result-1d.png}}
...
\begin{figure}[!ht]
    \centering
    \subfigure[sideway]{\includegraphics[width=0.95\textwidth]{images/aroon-macd/sideway.png}\label{fig:aroon-macd-side}}
    \subfigure[downtrend]{\includegraphics[width=0.95\textwidth]{images/aroon-macd/bear.png}}\label{fig:aroon-macd-down}
...
\begin{figure}[!ht]
    \centering
    \subfigure[sideway]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/sideway.png}\label{fig:rsi-bb-side}}
    \subfigure[downtrend]{\includegraphics[width=0.95\textwidth]{images/rsi-bb/bear.png} \label{fig:rsi-bb-down}}
